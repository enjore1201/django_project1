...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'aiter', 'all', 'any', 'chapter1.bin', 'bool', 'bytearray',
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all', 'any', 'apply', 'basestring', 'chapter1.bin',
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all', 'any', 'apply', 'basestring', 'chapter1.bin', 'bint',
